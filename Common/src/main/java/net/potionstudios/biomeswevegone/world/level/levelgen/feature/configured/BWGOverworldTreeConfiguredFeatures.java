...
//    );
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> WHITE_MANGROVE_TREE1 = ConfiguredFeaturesUtil.createConfiguredFeature("white_mangrove_tree1",
            TYGFeatures.TREE_FROM_NBT_V1,
            () -> new TreeFromStructureNBTConfig(
                    BiomesWeveGone.id("features/trees/white_mangrove/white_mangrove_tree1_base"),
                    BiomesWeveGone.id("features/trees/white_mangrove/white_mangrove_tree1_canopy"),
                    BiasedToBottomInt.of(5, 15),
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> WHITE_MANGROVE_TREE2 = ConfiguredFeaturesUtil.createConfiguredFeature("white_mangrove_tree2",
            TYGFeatures.TREE_FROM_NBT_V1,
            () -> new TreeFromStructureNBTConfig(
                    BiomesWeveGone.id("features/trees/white_mangrove/white_mangrove_tree2_base"),
                    BiomesWeveGone.id("features/trees/white_mangrove/white_mangrove_tree2_canopy"),
                    BiasedToBottomInt.of(5, 15),
                    BlockStateProvider.simple(BWGWood.WHITE_MANGROVE.logstem()),
                    BlockStateProvider.simple(BWGWood.WHITE_MANGROVE.leaves()),
                    Blocks.OAK_LOG,
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> WHITE_MANGROVE_TREE3 = ConfiguredFeaturesUtil.createConfiguredFeature("white_mangrove_tree3",
            TYGFeatures.TREE_FROM_NBT_V1,
            () -> new TreeFromStructureNBTConfig(
                    BiomesWeveGone.id("features/trees/white_mangrove/white_mangrove_tree3_base"),
                    BiomesWeveGone.id("features/trees/white_mangrove/white_mangrove_tree3_canopy"),
                    BiasedToBottomInt.of(5, 15),
                    BlockStateProvider.simple(BWGWood.WHITE_MANGROVE.logstem()),
                    BlockStateProvider.simple(BWGWood.WHITE_MANGROVE.leaves()),
                    Blocks.OAK_LOG,
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> WHITE_MANGROVE_TREE4 = ConfiguredFeaturesUtil.createConfiguredFeature("white_mangrove_tree4",
            TYGFeatures.TREE_FROM_NBT_V1,
            () -> new TreeFromStructureNBTConfig(
                    BiomesWeveGone.id("features/trees/white_mangrove/white_mangrove_tree4_base"),
                    BiomesWeveGone.id("features/trees/white_mangrove/white_mangrove_tree4_canopy"),
                    BiasedToBottomInt.of(5, 15),
                    BlockStateProvider.simple(BWGWood.WHITE_MANGROVE.logstem()),
                    BlockStateProvider.simple(BWGWood.WHITE_MANGROVE.leaves()),
                    Blocks.OAK_LOG,
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> WHITE_MANGROVE_TREE5 = ConfiguredFeaturesUtil.createConfiguredFeature("white_mangrove_tree5",
            TYGFeatures.TREE_FROM_NBT_V1,
            () -> new TreeFromStructureNBTConfig(
                    BiomesWeveGone.id("features/trees/white_mangrove/white_mangrove_tree5_base"),
                    BiomesWeveGone.id("features/trees/white_mangrove/white_mangrove_tree5_canopy"),
                    BiasedToBottomInt.of(5, 15),
                    BlockStateProvider.simple(BWGWood.WHITE_MANGROVE.logstem()),
                    BlockStateProvider.simple(BWGWood.WHITE_MANGROVE.leaves()),
                    Blocks.OAK_LOG,
    ...
    public static final Supplier<AttachedToLeavesDecorator> SOUL_FRUIT = () -> new AttachedToFruitLeavesDecorator(0.06F, 8, 8, BWGWood.FLOWERING_SPIRIT_LEAVES.get(), new RandomizedIntStateProvider(BlockStateProvider.simple(BWGBlocks.SOUL_FRUIT_BLOCK.get().defaultBlockState()), BWGFruitBlock.AGE, UniformInt.of(0, 3)), 2, List.of(Direction.DOWN));
